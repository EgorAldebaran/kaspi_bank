...
class Employee
{
    ...
    public function getSuperiorEmp(): ?int
    {
        return $this->superior_emp;
    }

    public function setSuperiorEmp(?int $superior_emp): static
    {
        $this->superior_emp = $superior_emp;
